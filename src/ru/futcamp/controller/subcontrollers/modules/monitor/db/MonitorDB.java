...
package ru.futcamp.controller.subcontrollers.modules.monitor.db;
 ...
 */
public class MonitorDB extends RedisClient implements IMonitorDB {
    /**
     ...
     */
    public MonitorDB(String host, int table) throws Exception {
        super(host, table);
    }
