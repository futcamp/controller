...
public class ThermHandler implements HttpHandler, IAppModule {
    private ILogger log;
    private IController ctrl;

    private String modName;

    public ThermHandler(String name, IAppModule... dep) {
        modName = name;
    ...
    public void handle(HttpExchange ex) {
        ...
        HttpResponse resp = new HttpResponse("therm", ex);
        ...
        try {
            ...
            log.error("Fail to process therm event: " + e.getMessage(), "THERMHDL");
            try {
                resp.simpleResult(false);
            } catch (Exception exc) {
                log.error("Fail to send therm response: " + exc.getMessage(), "THERMHDL");
            }
        }
